...
import 'admin_orderclerk_list.dart';

class adminOrderClerkAdd extends StatefulWidget {
  const adminOrderClerkAdd({Key? key}) : super(key: key);

  @override
  State<adminOrderClerkAdd> createState() => _adminOrderClerkAddState();
}

class _adminOrderClerkAddState extends State<adminOrderClerkAdd> {
  ...
  void initState() {
    super.initState();
    dbRef = FirebaseDatabase.instance.ref().child('Orderclerk');
  }
                  ...
                  children: <Widget>[
                    Container(
                      ...
                      child: FloatingActionButton.extended(
                        ...
                        onPressed: () {
                          Map<String, String> orderclerk = {
                            'userif' : user_idController.text,
